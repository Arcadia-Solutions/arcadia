...
/// A password reset link generated by a staff member for another user. The token it contains
/// allows its bearer to set a new password without being authenticated.
#[derive(Debug, Serialize, Deserialize, ToSchema)]
