...
pub trait NormalizedInfoFields<'a>: Sized {
    fn with_normalized_info_fields(self, info: &Info, torrent_source_tag: &'a str) -> Self;
}
...
pub fn compute_torrent_info_hash(info: &Info, torrent_source_tag: &str) -> Result<InfoHash> {
