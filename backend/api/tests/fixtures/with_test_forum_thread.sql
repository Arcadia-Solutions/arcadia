INSERT INTO
  forum_threads (id, forum_sub_category_id, name, created_at, created_by_id, posts_amount, pinned, locked)
VALUES
  ...
  (102, 100, 'Pinned Thread', '2025-01-01 12:00:00+00', 100, 1, true, false),
