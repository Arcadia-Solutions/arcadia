...
INSERT INTO forum_sub_categories (id, forum_category_id, name, sort_order, created_by_id, new_threads_restricted)
VALUES (102, 100, 'Restricted Sub Category', 3, 100, TRUE);
