...
async fn test_search_conversations_no_filter(pool: PgPool) {
    ...
    let req = test::TestRequest::get()
        .uri("/api/search/conversations?page=1&page_size=50&search_titles_only=true")
...
async fn test_search_conversations_by_subject(pool: PgPool) {
    ...
    let req = test::TestRequest::get()
        .uri("/api/search/conversations?search_term=jazz&search_titles_only=true&page=1&page_size=50")
        .insert_header(auth_header(&user.token))
        .to_request();
...
async fn test_search_conversations_by_content(pool: PgPool) {
    ...
    let req = test::TestRequest::get()
        .uri("/api/search/conversations?search_term=jazz&search_titles_only=false&page=1&page_size=50")
        .insert_header(auth_header(&user.token))
        .to_request();
...
async fn test_search_conversations_content_only_match(pool: PgPool) {
    ...
    let req = test::TestRequest::get()
        .uri("/api/search/conversations?search_term=seeding&search_titles_only=true&page=1&page_size=50")
        .insert_header(auth_header(&user.token))
        .to_request();
    ...
    let req = test::TestRequest::get()
        .uri("/api/search/conversations?search_term=seeding&search_titles_only=false&page=1&page_size=50")
        .insert_header(auth_header(&user.token))
        .to_request();
