...
export interface CreatePasswordResetToken201Response {
    'data': GeneratedPasswordResetToken;
    'side_effects': Array<SideEffect>;
}
...
/**
 * A password reset link generated by a staff member for another user. The token it contains allows its bearer to set a new password without being authenticated.
 */
...
export interface SearchBonusPointsLogsQuery {
    ...
    'to_date': string;
    /**
     * user whose logs are searched. searching the logs of another user requires the see_foreign_bonus_points_logs permission
     */
    'user_id': number;
}
...
export interface SimilarTitleGroupLite {
    'cover'?: string | null;
    'id': number;
    'name': string;
    'note'?: string | null;
...
export interface SimilarTitleGroupsLink {
    'group_1': number;
    'group_2': number;
    'note'?: string | null;
}
...
export interface TitleGroupAndAssociatedData {
    ...
    'related_threads': Array<RelatedForumThread>;
    'series'?: SeriesLite | null;
    'similar_title_groups': Array<SimilarTitleGroupLite>;
...
export const TorrentSearchOrderByColumn = {
    ...
    TorrentBonusPointsSnatchCost: 'torrent_bonus_points_snatch_cost'
} as const;
...
export const UserPermission = {
    ...
    EditUser: 'edit_user',
    GenerateResetPasswordToken: 'generate_reset_password_token',
...
export const resetPassword = async (userResetPassword: UserResetPassword, options?: RawAxiosRequestConfig): Promise<void> => {
    const response = await globalAxios.request<void>({
...
export const recomputeCachedAmounts = async (options?: RawAxiosRequestConfig): Promise<void> => {
    const response = await globalAxios.request<void>({
        url: '/api/maintenance-tools/recompute-cached-amounts',
        method: 'POST',
        ...options
    });
    return response.data;
...
export const getCollageSubscriptions = async (
    request: GetCollageSubscriptionsRequest,
    options?: RawAxiosRequestConfig
): Promise<GetCollageSubscriptions200Response['data']> => {
...
export const linkSimilarTitleGroups = async (similarTitleGroupsLink: SimilarTitleGroupsLink, options?: RawAxiosRequestConfig): Promise<void> => {
    const response = await globalAxios.request<void>({
        url: '/api/title-groups/similar',
        method: 'POST',
        data: similarTitleGroupsLink,
        ...options
    });
    return response.data;
};
...
export const unlinkSimilarTitleGroups = async (similarTitleGroupsLink: SimilarTitleGroupsLink, options?: RawAxiosRequestConfig): Promise<void> => {
    const response = await globalAxios.request<void>({
        url: '/api/title-groups/similar',
        method: 'DELETE',
        data: similarTitleGroupsLink,
...
export const createPasswordResetToken = async (id: number, options?: RawAxiosRequestConfig): Promise<CreatePasswordResetToken201Response['data']> => {
    const response = await globalAxios.request<CreatePasswordResetToken201Response>({
        url: `/api/users/{id}/password-reset-token`.replace('{' + 'id' + '}', String(id)),
        method: 'POST',
        ...options
    });
    return response.data.data;
