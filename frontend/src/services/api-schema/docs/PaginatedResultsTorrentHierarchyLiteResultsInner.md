# PaginatedResultsTorrentHierarchyLiteResultsInner
...
```typescript
import { PaginatedResultsTorrentHierarchyLiteResultsInner } from './api';

const instance: PaginatedResultsTorrentHierarchyLiteResultsInner = {
    audioBitrate,
